...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#FAF6F0] text-[#2B2622] flex flex-col font-sans selection:bg-[#C2704A] selection:text-white">
      <Header />
      ...
      <main className="flex-grow pt-16">
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="relative min-h-[85vh] lg:min-h-[88vh] bg-[#1C1815] text-[#FAF6F0] pt-24 pb-16 px-4 sm:px-6 lg:px-8 flex flex-col justify-between overflow-hidden">
          <HeroBackground variant="default" />

          {/* Top Badge Container */}
          <div className="relative z-10 max-w-7xl mx-auto w-full pt-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#26211D]/90 border border-[#C2704A]/40 text-xs font-semibold text-[#F0E6D8]">
              <span className="w-2 h-2 rounded-full bg-[#5C6B5D] animate-pulse" />
          ...
          <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center my-auto py-8">
            ...
            <div className="lg:col-span-7 space-y-6">
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#FAF6F0] font-heading leading-[1.05] max-w-2xl">
                Technology That Manages, Connects & Protects Your Business
              </h1>

              <p className="text-sm sm:text-base lg:text-lg text-[#F0E6D8]/80 leading-relaxed max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
                <Link
                  href="/contact"
                  className="btn-primary-clay px-6 py-3.5 rounded-lg text-sm font-bold shadow-lg text-center"
                >
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="bg-[#26211D] text-[#F0E6D8] py-5 border-y border-[#C2704A]/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 text-center">
              <div className="flex items-center justify-center gap-2 p-2">
                <Cpu className="w-4 h-4 text-[#C2704A]" />
        ...
        <section className="py-20 bg-[#FAF6F0] px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-14">
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#2B2622] font-heading">
                Our Three Core Solutions
              </h2>
              <p className="text-sm sm:text-base text-[#2B2622]/70 mt-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="bg-[#F0E6D8]/60 rounded-2xl p-8 card-interactive h-full flex flex-col justify-between border border-[#F0E6D8]">
                <div>
                  <div className="w-12 h-12 rounded-xl bg-[#FAF6F0] text-[#C2704A] flex items-center justify-center mb-6 card-icon border border-[#C2704A]/20">
                    <Building2 className="w-6 h-6" />
                  </div>
                  <h3 className="text-xl font-bold text-[#2B2622] font-heading mb-3">
                  ...
                  <div className="space-y-2 mb-6">
                    {[
                      ...
                      <div key={item} className="flex items-center gap-2 text-xs text-[#2B2622]">
                        <CheckCircle2 className="w-4 h-4 text-[#C2704A] shrink-0" />
                        <span>{item}</span>
                      </div>
                    ))}
                  </div>
                ...
                <Link
                  href="/solutions/vendor-management"
                  className="btn-primary-clay inline-flex items-center justify-between px-4 py-3 rounded-lg font-bold text-xs mt-auto"
                >
              ...
              <div className="bg-[#1C1815] text-[#FAF6F0] rounded-2xl p-8 border border-[#5C6B5D]/40 shadow-xl sage-glow card-interactive h-full flex flex-col justify-between">
                <div>
                  <div className="w-12 h-12 rounded-xl bg-[#5C6B5D]/20 text-[#5C6B5D] flex items-center justify-center mb-6 border border-[#5C6B5D]/40 card-icon">
                    <ShieldCheck className="w-6 h-6" />
                  </div>
                  <h3 className="text-xl font-bold text-[#FAF6F0] font-heading mb-3">
                    Cybersecurity Services
                  </h3>
                  <p className="text-xs sm:text-sm text-[#F0E6D8]/80 leading-relaxed mb-6">
                  ...
                  <div className="space-y-2 mb-6">
                    {[
                      ...
                      <div key={item} className="flex items-center gap-2 text-xs text-[#F0E6D8]">
                        <CheckCircle2 className="w-4 h-4 text-[#5C6B5D] shrink-0" />
                        <span>{item}</span>
                      </div>
                    ))}
                  </div>
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="py-20 bg-[#1C1815] text-[#FAF6F0] px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            {/* Left 40%: Description */}
            <div className="lg:col-span-5 space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#26211D] border border-[#C2704A]/40 text-xs font-semibold text-[#F0E6D8]">
                Connected Architecture
              </div>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#FAF6F0] font-heading">
                The Vendonexa Integrated Ecosystem
              </h2>
              <p className="text-xs sm:text-sm text-[#F0E6D8]/80 leading-relaxed">
                Combining business operations, clinical workflows, and threat defense into one synchronized digital framework.
              </p>
              <div className="p-4 rounded-xl bg-gradient-to-r from-[#C2704A]/20 to-[#8B5E3C]/20 border border-[#C2704A]/40 mt-4">
                <span className="text-xs font-bold font-heading text-[#FAF6F0] uppercase tracking-wider">
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="bg-[#26211D]/80 p-5 rounded-xl border border-[#C2704A]/30 card-interactive">
                <div className="flex items-center gap-3 mb-2">
                  <Building2 className="w-6 h-6 text-[#C2704A]" />
                  <h3 className="text-base font-bold text-[#FAF6F0] font-heading">
                    Manage Your Business Ecosystem
                  </h3>
                </div>
                <p className="text-xs text-[#F0E6D8]/80 leading-relaxed pl-9">
              ...
              <div className="bg-[#26211D]/80 p-5 rounded-xl border border-[#C2704A]/30 card-interactive">
                <div className="flex items-center gap-3 mb-2">
                  <Stethoscope className="w-6 h-6 text-[#C2704A]" />
                  <h3 className="text-base font-bold text-[#FAF6F0] font-heading">
              ...
              <div className="bg-[#26211D]/80 p-5 rounded-xl border border-[#5C6B5D]/40 card-interactive">
                <div className="flex items-center gap-3 mb-2">
                  <ShieldCheck className="w-6 h-6 text-[#5C6B5D]" />
                  <h3 className="text-base font-bold text-[#FAF6F0] font-heading">
        ...
        <section className="py-20 bg-[#FAF6F0] px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto space-y-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-5 space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F0E6D8] text-[#C2704A] text-xs font-semibold">
                  Vendor Management Division
                </div>
                <h2 className="text-2xl sm:text-4xl font-extrabold text-[#2B2622] font-heading">
                  Complete Vendor Lifecycle Management
                </h2>
                <p className="text-xs sm:text-sm text-[#2B2622]/80 leading-relaxed">
                ...
                <div className="pt-2">
                  <Link
                    href="/solutions/vendor-management"
                    className="btn-primary-clay px-5 py-3 rounded-lg text-xs font-bold inline-flex items-center gap-2"
                  >
              ...
              <div className="lg:col-span-7 space-y-4">
                <div className="p-4 bg-[#F0E6D8]/60 rounded-xl border border-[#F0E6D8]">
                  <span className="text-[11px] font-bold uppercase text-[#8B5E3C] block mb-2">
                    Structured Lifecycle Pipeline:
                  </span>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center text-[10px] font-semibold text-[#2B2622]">
                    <div className="p-2 bg-[#FAF6F0] rounded border border-[#F0E6D8]">1. Register</div>
                    <div className="p-2 bg-[#FAF6F0] rounded border border-[#F0E6D8]">2. Verify</div>
                    <div className="p-2 bg-[#FAF6F0] rounded border border-[#F0E6D8]">3. RFQ Tender</div>
                    <div className="p-2 bg-[#FAF6F0] rounded border border-[#F0E6D8]">4. Contract</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="py-20 bg-[#F0E6D8]/50 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto space-y-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7 order-2 lg:order-1">
                <div className="p-4 bg-[#FAF6F0] rounded-xl border border-[#F0E6D8]">
                  <span className="text-[11px] font-bold uppercase text-[#C2704A] block mb-2">
                    Digital Patient Care Journey:
                  </span>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center text-[10px] font-semibold text-[#2B2622]">
                    <div className="p-2 bg-[#F0E6D8]/60 rounded border border-[#F0E6D8]">1. Intake</div>
                    <div className="p-2 bg-[#F0E6D8]/60 rounded border border-[#F0E6D8]">2. EMR Consult</div>
                    <div className="p-2 bg-[#F0E6D8]/60 rounded border border-[#F0E6D8]">3. Lab/Rx</div>
                    <div className="p-2 bg-[#F0E6D8]/60 rounded border border-[#F0E6D8]">4. Billing</div>
                  </div>
                </div>
              </div>

              <div className="lg:col-span-5 order-1 lg:order-2 space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white text-[#C2704A] border border-[#C2704A]/30 text-xs font-semibold">
                  Healthcare Division
                </div>
                <h2 className="text-2xl sm:text-4xl font-extrabold text-[#2B2622] font-heading">
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="py-20 bg-[#1C1815] text-[#FAF6F0] px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto space-y-12">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#5C6B5D]/20 border border-[#5C6B5D]/40 text-[#5C6B5D] text-xs font-semibold mb-3">
                Cybersecurity Division
              </div>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#FAF6F0] font-heading">
                Protecting Applications, Infrastructure and Data
              </h2>
              <p className="text-xs sm:text-sm text-[#F0E6D8]/80 mt-2 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={c.step} className="bg-[#26211D] p-6 rounded-xl border border-[#5C6B5D]/30 card-interactive">
                  <h3 className="text-base font-bold text-[#5C6B5D] font-heading mb-3">
                    {c.step}
                  </h3>
                  <ul className="space-y-1.5 text-xs text-[#F0E6D8]/80">
                    {c.items.map((i) => (
                      <li key={i}>• {i}</li>
                    ))}
                  </ul>
            ...
            <div className="text-center">
              <Link
                href="/solutions/cybersecurity"
                className="btn-primary-clay px-6 py-3.5 rounded-lg text-xs font-bold inline-flex items-center gap-2"
              >
        ...
        <section className="py-20 bg-[#FAF6F0] px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-14">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F0E6D8] text-[#C2704A] text-xs font-semibold mb-3">
                Engineering Capabilities
              </div>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#2B2622] font-heading">
                Technology Built Around Your Business
              </h2>
              <p className="text-xs sm:text-sm text-[#2B2622]/80 mt-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 text-center">
              {[
                ...
                <div
                  key={service}
                  className="p-4 rounded-xl bg-[#F0E6D8]/60 card-interactive font-semibold text-[#2B2622] text-xs border border-[#F0E6D8]"
                >
                  {service}
                </div>
              ))}
            ...
            <div className="mt-10 text-center">
              <Link
                ...
                className="btn-primary-clay px-6 py-3 rounded-lg text-xs font-bold inline-flex items-center gap-2"
              >
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="py-20 bg-[#1C1815] px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="py-20 bg-[#F0E6D8]/40 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-14">
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#2B2622] font-heading">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.title} className="bg-[#FAF6F0] p-6 rounded-xl card-interactive border border-[#F0E6D8]">
                  <h3 className="font-bold text-[#2B2622] text-base font-heading mb-2">
                    {item.title}
                  </h3>
                  <p className="text-xs text-[#2B2622]/80 leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.step} className="bg-[#F0E6D8]/50 p-6 rounded-xl card-interactive relative border border-[#F0E6D8]">
                  <span className="font-mono font-extrabold text-2xl text-[#C2704A] opacity-60 block mb-2">
                    {item.step}
                  </span>
                  <h3 className="font-bold text-[#2B2622] text-base font-heading mb-1">
                    {item.name}
                  </h3>
                  <p className="text-xs text-[#2B2622]/80 leading-relaxed">{item.text}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="py-20 bg-[#26211D] text-[#FAF6F0] px-4 sm:px-6 lg:px-8 text-center relative border-y border-[#C2704A]/30">
          <div className="max-w-4xl mx-auto space-y-6 relative z-10">
            <h2 className="text-3xl sm:text-5xl font-extrabold font-heading text-white">
              Manage Smarter. Operate Better. Stay Secure.
            </h2>
            <p className="text-xs sm:text-sm text-[#F0E6D8]/80 leading-relaxed max-w-3xl mx-auto">
            ...
            <div className="pt-4 flex items-center justify-center gap-4">
              <Link
                href="/contact"
                className="btn-primary-clay px-6 py-3.5 rounded-lg text-xs font-bold shadow-lg"
              >
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section id="contact-section" className="py-20 bg-[#FAF6F0] px-4 sm:px-6 lg:px-8">
